...
public class conservacion1 extends AppCompatActivity {
    ...
    private static final String TAG = "conservacion1";
    ...
    public void openLastField(View v){
        ...
        Intent intentDetails = new Intent(conservacion1.this, nextField);
...
//        Intent intentDetails = new Intent(conservacion1.this, conservacion0.class);
//        Bundle bundle = new Bundle();
//        bundle.putString("familyNum", familyNum);
//        bundle.putString("visitNum", visitNum);
//        intentDetails.putExtras(bundle);
